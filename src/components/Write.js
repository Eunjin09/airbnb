...
function Write() {
  ...
  const { houseName, address, houseInfo, price, personCnt, wifi, parking, laundry } = getInputs;
  ...
  // 작성시 검사
  const checked = (data) => {
    let array = [houseName, address, houseInfo, price, personCnt, wifi, parking, laundry];
    ...
    <div style={{ display: 'flex' }}>
      ...
      <ScreenRight>
        <InputBox>
          ...
          <button onClick={() => { setOpen(!getOpen) }}>주소찾기</button>
        </InputBox>
